...
class StylesPro extends GFAddOn {
    ...
    */
    ...
    public function init_admin() {
        ...
        add_action( 'gform_editor_js', array( $this, 'choices_ornament_editor_script' ), 10 );
    ...
    public function init_frontend() {
        ...
        */
        add_action( 'gform_register_init_scripts', array($this, 'gf_stylespro_icon_after_script') );
    ...
    */
            ...
            array(
                ...
                'fields' => array(
                    array(
                        ...
                        'after_select' =>  ' &nbsp; <a class="button" href="' . esc_url( admin_url( 'admin.php?page=gf_settings&subview=gf_stylespro' ) ) . '">Edit themes <i>in Styles Pro Settings</i></a>',
    ...
    function gf_stylespro_icon_after_script( $form ) {
...
jQuery(window).load( function(){
    ...
    function gf_stylespro_enq( $form ) {
        ...
        if ( ! empty($theme) && $theme != "none" ) {
            ...
            if ( $gfsp_plugin_settings[$theme . '_theme_css'] ) {
    ...
    function gf_stylespro_add( $form ) {
        ...
        if (!empty($theme) && $theme != "none") {
            $form['cssClass'] = $current_class . ' gf_stylespro ' . $theme;
        }
    ...
    */
    function gf_stylespro_field_icon( $field_content, $field, $value, $lead_id, $form_id ) {
        ...
        if ( $field->gfStylesProIcon ) {
            ...
            if ( ! in_array( 'icn_'.$iconset, $this->_iconsets ) )
            ...
            $field_content = str_replace( 'ginput_container ', 'ginput_container has_gfsp_icn ', $field_content );


            if ( $field->type == 'select') {
                $field_content = str_replace( '<select', '<span class="gfsp_icon"><i '. $color .'class="'. $icon . '"></i></span><select', $field_content );
            }
                ...
                if ( $replace_input ) {
                    $replace = '<span class="gfsp_icon"><i '. $color .'class="'. $icon . '"></i></span><input';
                ...
                if ($replace_select) {
                    $replace = '<span class="gfsp_icon"><i '. $color .'class="'. $icon . '"></i></span><select';
                ...
                $field_content = str_replace( '<input', '<span class="gfsp_icon"><i '. $color .'class="'. $icon . '"></i></span><input', $field_content );
            }
        }
        ...
        if ( $position == 1362 ) {
            ...
            <div class="box">
                    ...
                    if ( empty ( $this->_iconsets ) ){
                        ...
                        echo '<h4>No icon-sets are enabled for this form. Go to Form Settings > <a href="' . $gfsp_settings_link . '">Styles Pro</a> add icon-sets.</h4>';
                    } else {
                        ?>
                    ...
                    ?>
            <h3 class="gfsp_image h h_checkbox h_radio h_poll h_quiz h_option h_post_tags-checkbox h_post_tags-radio h_post_custom_field-checkbox h_post_custom_field-radio h_product-checkbox h_product-radio">Image</h3>
    ...
    * Form Editor
    */
    public function choices_ornament_editor_script() {
        ?>
    ...
    ?>
            <li class="gfsp_styles field_setting">
                ...
                <div class="gfsp_special" style="display: none">
                    ...
                    <input id="gf_scroll_text" type="checkbox" name="gf_scroll_text" value="">
                    ...
                    <input id="gf_hide_complex_label" type="checkbox" name="gf_hide_complex_label" value="gf_hide_complex_label">
                        <label for="gf_hide_complex_label" class="h h_address h_name" style="display: none;">Hide inner labels</label>
                ...
                <div class="gfsp_lists h" style="display: none">
                    ...
                    <input id="gf_list_inline" class="has_img" type="radio" name="gfsp_list_col" value="gf_list_inline" title="Inline">
                        <label for="gf_list_inline" data-hover="Automatic"><img src="<?php echo $gfsp_dir ?>icons/listinline.png"></label>
                </div>
    ...
    if ( is_array( $gfsp_themes ) || is_object( $gfsp_themes ) )
    {
        ...
        foreach ( $gfsp_themes as $key => $theme ) {
            ...
            array(
                ...
                "id"    =>  $theme['value'],
                "description"   => 'Fonts for <strong>Form</strong> and <strong>Field labels</strong> for this theme can be customized here <strong><i>(<a href="#" onclick="resetToDefaults(\'' . $theme['value'] . '\',\'' . $theme['label'] . '\')">reset changes</a>)</i></strong>.<br><br>You may use any Google Font from the lists (<a target="_blank" href="https://fonts.google.com/">preview Google Fonts</a>). Please note that GF Styles Pro will only load fonts on pages which use a form with this theme, ensuring best practices for speed.',
                "fields" =>
                    array(
                        /*
                        *   Label Font Settings 
...
tr[id$=label_font_color],tr[id$=field_margin_bottom],tr[id$=o_custom_bg] { border-bottom: 27px solid rgba(246, 251, 253, 0) }
...
tr[id$=_font] th,tr[id$=btn_color] th,tr[id$=background] th { font-weight: bold !important }
...
/*
* Add wrapper for GravityView plugin
*/
