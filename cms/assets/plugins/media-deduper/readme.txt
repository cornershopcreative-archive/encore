...
1. A page listing all of your duplicate media files. The list makes it easy to see and delete duplicate files: delete one and its twin will disappear from the list because it's then no longer a duplicate. Easy!
...
Also note that deleting media may cause posts to lose their Featured Images, because the attachments they're linked to are being deleted. Future versions of Media Deduper may offer a way to automatically re-assign post thumbnails to the retained images when duplicates are removed. Just not there yet.
