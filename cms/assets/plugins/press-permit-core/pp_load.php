...
function pp_is_front() {
	$is_front = ( ! is_admin() && ! defined('XMLRPC_REQUEST') && ! defined('DOING_AJAX') && ( ! defined('REST_REQUEST') || ! REST_REQUEST ) && ! pp_doing_cron() );
	return ( defined('REST_REQUEST') && REST_REQUEST ) ? apply_filters( 'pp_is_front', $is_front ) : $is_front;
}
