...
class PP_Options_Core {
	...
	function options_ui() {
		...
		if ( ! empty( $ui->form_options[$tab][$section] ) ) :?>
			...
			$hint = ( 0 === validate_plugin( "pp-collaborative-editing/pp-collaborative-editing.php" ) && ! $listable ) ? __('Note: To allow listing of uneditable posts in wp-admin, define constant PP_ADMIN_READONLY_LISTABLE', 'pp') : '';
			$args = ( defined( 'PPCE_VERSION' ) && ! $listable )? array( 'val' => 1, 'disabled' => true, 'no_storage' => true ) : array();
