...
function crate_enqueue() {
  ...
  if ( ! is_admin() ) {
		wp_enqueue_style( 'crate_style', get_template_directory_uri() . '/css/crate.css', array(), '4.4.16' );
		wp_enqueue_script( 'crate', get_template_directory_uri() . '/js/crate.js', array('jquery'), '4.4.16', true );
...
function crate_enqueue_admin() {
  ...
  if ( 'toplevel_page_crate-site-options' === $screen->id ) {
    wp_enqueue_script( 'crate_admin', get_template_directory_uri() . '/admin.js', array( 'jquery' ), '4.4.16' );
  }
}
